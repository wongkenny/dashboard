        ...
        <script type="text/javascript" language="javascript" >
            $(document).ready(function() {
               var dataTable =  $('#employee-grid').DataTable( {
                ...
                processing: true,
                serverSide: true,
                ajax: "employee-grid-data3.php", // json datasource
                } );
            } );
        </script>
         ...
         <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="manage_hotel.php"><i class="fa fa-hotel"></i> <span>Manage Hotels</span></a></li>
             <li class="active"><a href="manage_users.php"><i class="fa fa-users"></i> <span>Manage Users</span></a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Enter the ID of the user to be edited:</p>
           ...
           <div id='hidden' style='display:none;'>
            <form class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                 <textarea class="form-control" rows="3" placeholder="username" id="inputUsername"></textarea>
                  </div>
                </div>
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputmob" placeholder="+230">
                  </div>
                </div>
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputdob" placeholder="mm/dd/yyy">
                    </div>
                </div>
              ...
              <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Favorite Activity 1</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputf1" placeholder="preference">
                    </div>
                </div>
              
              
               <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Favorite Activity 2</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputf2" placeholder="preference">
                    </div>
                </div>
				
				 <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Favorite Activity 3</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputf3" placeholder="preference">
                    </div>
                </div>
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputDate" placeholder="mm/dd/yyy">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
          <p>Enter the ID of the user to be deleted:</p>
           <input type='text'>
        </div>
        <div class="modal-footer">
