        ...
        <script type="text/javascript" language="javascript" >
            $(document).ready(function() {
               var dataTable =  $('#employee-grid').DataTable( {
                ...
                processing: true,
                serverSide: true,
                ajax: "employee-grid-data1.php", // json datasource
                } );
            } );
        </script>
      ...
      <aside class="main-sidebar">
         ...
         <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="manage_reservation.php"><i class="fa fa-file-text-o"></i> <span>Manage Reservations</span></a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <p>Enter the ID of the Reservation to be edited:</p>
           <div id='controls'><input type='text'> <button type="button" class="submit_edit">Search</button></div>
           <div id='hidden' style='display:none;'>
            <form class="form-horizontal">
                <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">Reservation Name</label>
                  <div class="col-sm-10">
              ...
              <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputStart" placeholder="mm/dd/yyy">
                    </div>
                </div>
              
              <div class="form-group">
                    <label for="inputEmail3" class="col-sm-2 control-label">Ending date</label>
                    <div class="col-sm-10">
                      <input type="text" class="form-control" id="inputEnd" placeholder="mm/dd/yyy">
                    </div>
                </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="text-align:center;">
          <p>Enter the ID of the reservation to be deleted:</p>
           <input type='text'>
        </div>
        <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
